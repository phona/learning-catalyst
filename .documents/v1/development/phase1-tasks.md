...
- [ ] Write unit tests for model abstraction
...
- [ ] Update to better integrate with local Markdown files for context awareness
...
- [ ] Write unit tests for challenge engine
...
- [ ] Add integration with local Markdown files for content extraction
- [ ] Add parsing of Markdown content to identify concepts
- [ ] Add hierarchical concept relationship mapping
...
- [ ] Write unit tests for command palette
...
### 15. Guided Startup Enhancement (CRITICAL - PENDING)
- [ ] Enhance Catalyst Agent to generate dynamic, context-aware welcome messages
- [ ] Implement logic for summarizing last point of discussion on resumption
- [ ] Add proposal of specific, actionable next steps to re-engage user
- [ ] Add lightweight scan of available local Markdown files for new users
- [ ] Add guided suggestion of first topic based on scanned content
- [ ] Complete integration with local content for truly contextual experience