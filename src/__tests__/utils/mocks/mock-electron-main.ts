...
export const mockScreen = {
  getPrimaryDisplay: vi.fn().mockReturnValue(primaryDisplay),
  getAllDisplays: vi.fn().mockReturnValue([primaryDisplay]),
  getDisplayNearestPoint: vi.fn().mockReturnValue(primaryDisplay),
  getDisplayMatching: vi.fn().mockReturnValue(primaryDisplay),
  on: vi.fn(),
  once: vi.fn(),
  removeAllListeners: vi.fn(),
  emit: vi.fn()
