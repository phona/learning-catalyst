  ...
  getHealthStatus() {
    ...
    return {
      ...
      memory: {
        ...
        status: memory.percentage < this.OPTIMIZATION_THRESHOLDS.MEMORY_WARNING ? 'healthy' :
          memory.percentage < this.OPTIMIZATION_THRESHOLDS.MEMORY_CRITICAL ? 'warning' : 'critical'
      },
      bottlenecks: {
      ...
      caches: {
        ...
        utilization: (caches.service.utilizationPercent + caches.analytics.utilizationPercent + caches.ui.utilizationPercent) / 3
      }
    };
  }
}
