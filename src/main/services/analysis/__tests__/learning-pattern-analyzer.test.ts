...
describe('LearningPatternAnalyzer', () => {
  ...
  describe('Question Pattern Analysis', () => {
    it('should detect question-asking behavior correctly', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Hooks are powerful for state management', timestamp: Date.now() - 120000 },
          { role: 'user', content: 'What does useState do exactly?', timestamp: Date.now() - 90000 },
          { role: 'user', content: 'How is it different from local state?', timestamp: Date.now() - 60000 },
          { role: 'user', content: 'Can you show me an example?', timestamp: Date.now() - 30000 },
          { role: 'user', content: 'I want to understand when to use hooks', timestamp: Date.now() }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
    ...
    it('should analyze question complexity', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          ...
          { role: 'user', content: 'What is the difference between shallow and deep equality in JavaScript?', timestamp: Date.now() - 90000 },
          { role: 'user', content: 'Can you explain the concept of referential transparency?', timestamp: Date.now() - 60000 },
          { role: 'user', content: 'How do composition and inheritance differ in class-based components?', timestamp: Date.now() - 30000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
  ...
  describe('Retry and Practice Pattern Analysis', () => {
    it('should detect retry behavior when user struggles', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Previous explanation about useState', timestamp: Date.now() - 180000 },
          { role: 'user', content: 'Let me try implementing useState again', timestamp: Date.now() - 120000 },
          { role: 'user', content: 'I will attempt a different approach', timestamp: Date.now() - 90000 },
          { role: 'user', content: 'Here is my retry code for the counter component', timestamp: Date.now() - 60000 },
          { role: 'user', content: 'Let me test this new implementation', timestamp: Date.now() - 30000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
      ...
      expect(retryPattern!.recommendations).toContain('Leverage persistence in more complex challenges');
    });

    it('should distinguish between practicing and retrying', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Explanation of React hooks', timestamp: Date.now() - 120000 },
          { role: 'user', content: 'I want to practice useState by building a component', timestamp: Date.now() - 90000 },
          { role: 'user', content: 'Let me create a practice project', timestamp: Date.now() - 60000 },
          { role: 'user', content: 'I am practicing different scenarios with hooks', timestamp: Date.now() - 30000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
  ...
  describe('Breakthrough Pattern Analysis', () => {
    it('should detect breakthrough moments', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Previous explanation of useEffect', timestamp: Date.now() - 120000 },
          { role: 'user', content: 'I was confused but suddenly it clicked!', timestamp: Date.now() - 90000 },
          { role: 'user', content: 'Aha! I see how dependencies work now', timestamp: Date.now() - 60000 },
          { role: 'user', content: 'Eureka! The dependency array makes perfect sense', timestamp: Date.now() - 30000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
    ...
    it('should calculate time between breakthroughs', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          ...
          { role: 'user', content: 'Breakthrough! This clicked too', timestamp: Date.now() - 1800000 }, // 30 minutes ago
  ...
  describe('Engagement Pattern Analysis', () => {
    it('should analyze user engagement levels', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Previous explanation', timestamp: Date.now() - 120000 },
          { role: 'user', content: 'I understand and want to ask more questions', timestamp: Date.now() - 90000 },
          { role: 'user', content: 'Can we explore more complex examples? I want to dive deeper into hooks.', timestamp: Date.now() - 60000 },
          { role: 'user', content: 'This is fascinating and I want to understand the internals. How does the component lifecycle work with hooks? And what about useCallback optimization?', timestamp: Date.now() - 30000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
  ...
  describe('Practice Preference Analysis', () => {
    it('should detect strong practice preference', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Explanation of React hooks', timestamp: Date.now() - 180000 },
          { role: 'user', content: 'I want more practice with hooks, can you give me hands-on examples?', timestamp: Date.now() - 120000 },
          { role: 'user', content: 'Let me practice useState with real examples', timestamp: Date.now() - 90000 },
          { role: 'user', content: 'I need more practical exercises, not just theory', timestamp: Date.now() - 60000 },
          { role: 'user', content: 'Can we do more hands-on learning?', timestamp: Date.now() - 30000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
      ...
      const practicePreferencePattern = result.patterns.find(p => p.type === 'practice_preference');
      expect(practicePreferencePattern).toBeDefined();
      expect(practicePreferencePattern!.implications).toContain('User strongly prefers practice-based learning');
      expect(practicePreferencePattern!.recommendations).toContain('Provide frequent hands-on opportunities');
    });
    ...
    it('should detect practice avoidance', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Explanation of React hooks', timestamp: Date.now() - 180000 },
          { role: 'user', content: 'No thanks, I prefer theory only', timestamp: Date.now() - 120000 },
          { role: 'user', content: 'I don\'t want any hands-on examples', timestamp: Date.now() - 90000 },
          { role: 'user', content: 'Just explain the concepts without practice', timestamp: Date.now() - 60000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
      ...
      const practicePreferencePattern = result.patterns.find(p => p.type === 'practice_preference');
      expect(practicePreferencePattern).toBeDefined();
      expect(practicePreferencePattern!.implications).toContain('User may prefer theoretical learning');
      expect(practicePreferencePattern!.recommendations).toContain('Focus on conceptual understanding first');
    });
  });
  ...
  describe('Stuck Point Analysis', () => {
    it('should identify existing stuck points from user context', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Explanation of useEffect', timestamp: Date.now() - 120000 },
          { role: 'user', content: 'I was confused about useEffect dependencies', timestamp: Date.now() - 90000 },
          { role: 'user', content: 'This concept is still difficult for me', timestamp: Date.now() - 60000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
    ...
    it('should identify new stuck points from conversation', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Explanation of useCallback', timestamp: Date.now() - 180000 },
          { role: 'user', content: 'I\'m confused about useCallback and don\'t understand how to optimize re-renders', timestamp: Date.now() - 120000 },
          { role: 'user', content: 'This optimization concept is stuck in my head', timestamp: Date.now() - 90000 },
          { role: 'user', content: 'I\'m really struggling with when to use useReducer', timestamp: Date.now() - 60000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
    ...
    it('should categorize stuck point severity correctly', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Explanation of custom hooks', timestamp: Date.now() - 180000 },
          { role: 'user', content: 'I am confused about this advanced topic and keep getting it wrong', timestamp: Date.now() - 120000 },
          { role: 'user', content: 'I don\'t understand and I\'m really struggling, I think I need to go back to basics', timestamp: Date.now() - 90000 },
          { role: 'user', content: 'This is way too difficult for me right now', timestamp: Date.now() - 60000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
  ...
  describe('Progress Analysis', () => {
    it('should analyze confidence improvement over time', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Initial explanation of useState', timestamp: Date.now() - 7200000 },
          { role: 'user', content: 'I think I understand but I\'m not sure', timestamp: Date.now() - 3600000 },
          { role: 'user', content: 'I understand useState now!', timestamp: Date.now() - 1800000 },
          { role: 'user', content: 'I really get useState and can explain it to others', timestamp: Date.now() - 900000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
          ...
          stuckPoints: [],
          recentConcepts: [
            { concept: 'useState', confidence: 0.9, firstSeen: Date.now() - 7200000, lastSeen: Date.now() - 900000, practiceCount: 2 }
          ],
          engagementLevel: 0.8,
          preferences: {
            practiceFrequency: 'high',
    ...
    it('should determine mastery levels correctly', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Explanation of React patterns', timestamp: Date.now() - 180000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
          ...
          stuckPoints: [],
          recentConcepts: [
            { concept: 'useState', confidence: 0.95, firstSeen: Date.now() - 86400000, lastSeen: Date.now(), practiceCount: 10 },
            { concept: 'useEffect', confidence: 0.92, firstSeen: Date.now() - 43200000, lastSeen: Date.now() - 8640000, practiceCount: 8 },
            { concept: 'customHooks', confidence: 0.88, firstSeen: Date.now() - 21600000, lastSeen: Date.now() - 3600000, practiceCount: 5 }
          ],
  ...
  describe('Practice Recommendations', () => {
    it('should generate recommendations for stuck points', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          ...
          { role: 'user', content: 'I\'m confused about when to use useState vs useReducer', timestamp: Date.now() - 90000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
      ...
      const stuckPointRecommendation = result.practiceRecommendations.find(pr => pr.type === 'remedial_practice');
    ...
    it('should generate advancement recommendations for proficient users', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Advanced React hooks explanation', timestamp: Date.now() - 120000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
          ...
          stuckPoints: [],
          recentConcepts: [
            { concept: 'useState', confidence: 0.95, firstSeen: Date.now() - 86400000, lastSeen: Date.now(), practiceCount: 15 },
            { concept: 'useEffect', confidence: 0.92, firstSeen: Date.now() - 43200000, lastSeen: Date.now() - 3600000, practiceCount: 12 }
          ],
          engagementLevel: 0.9,
          preferences: {
            practiceFrequency: 'high',
      ...
      const advancementRecommendation = result.practiceRecommendations.find(pr => pr.type === 'advancement_practice');
    ...
    it('should generate preference-aligned recommendations', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          ...
          { role: 'user', content: 'I love hands-on practice, can we do more practical exercises?', timestamp: Date.now() - 90000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
      ...
      const preferenceRecommendation = result.practiceRecommendations.find(pr => pr.type === 'preference_aligned');
    ...
    it('should calculate learning velocity metrics', async () => {
      const request: LearningPatternRequest = {
        ...
        userContext: {
          ...
          stuckPoints: [],
          recentConcepts: [
            { concept: 'useState', confidence: 0.7, firstSeen: Date.now() - 86400000, lastSeen: Date.now() - 43200000, practiceCount: 5 },
            { concept: 'useEffect', confidence: 0.85, firstSeen: Date.now() - 43200000, lastSeen: Date.now() - 21600000, practiceCount: 3 }
          ],
          engagementLevel: 0.8,
          preferences: {
            practiceFrequency: 'medium',
    ...
    it('should detect declining velocity trend', async () => {
      const request: LearningPatternRequest = {
        ...
        userContext: {
          ...
          stuckPoints: [],
          recentConcepts: [
            { concept: 'useState', confidence: 0.5, firstSeen: Date.now() - 86400000, lastSeen: Date.now() - 43200000, practiceCount: 5 },
            { concept: 'useEffect', confidence: 0.4, firstSeen: Date.now() - 43200000, lastSeen: Date.now() - 21600000, practiceCount: 3 }
          ],
          engagementLevel: 0.5,
          preferences: {
            practiceFrequency: 'low',
  ...
  describe('Next Steps Generation', () => {
    it('should generate relevant next steps', async () => {
      const request: LearningPatternRequest = {
        conversationHistory: [
          { role: 'assistant', content: 'Comprehensive explanation', timestamp: Date.now() - 120000 }
        ],
        userContext: {
          id: 'user1',
          sessionId: 'session1',
    ...
    it('should limit next steps to reasonable number', async () => {
      const request: LearningPatternRequest = {
        ...
        userContext: {
          ...
          confidenceLevel: 0.7,
          learningVelocity: 1.1,
          stuckPoints: [], // No stuck points
          recentConcepts: [
            { concept: 'useState', confidence: 0.9, firstSeen: Date.now() - 86400000, lastSeen: Date.now(), practiceCount: 10 },
            { concept: 'useEffect', confidence: 0.85, firstSeen: Date.now() - 43200000, lastSeen: Date.now() - 21600000, practiceCount: 8 },
            { concept: 'customHooks', confidence: 0.8, firstSeen: Date.now() - 21600000, lastSeen: Date.now() - 10800000, practiceCount: 5 },
            { concept: 'useContext', confidence: 0.95, firstSeen: Date.now() - 8640000, lastSeen: Date.now(), practiceCount: 7 },
            { concept: 'useReducer', confidence: 0.88, firstSeen: Date.now() - 10800000, lastSeen: Date.now() - 3600000, practiceCount: 6 }
          ],
          engagementLevel: 0.9,
          preferences: {
            practiceFrequency: 'high',
      ...
      expect(result.nextSteps).toContain('Consider project-based practice combining multiple concepts');
    });
  });
