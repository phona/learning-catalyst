/**
 * Analytics & Progress IPC Handlers
 *
 * IPC handlers for learning analytics, progress tracking,
...
/**
 * Setup analytics and progress IPC handlers
 */
export function setupAnalyticsHandlers(): void {
  ...
  ipcMain.handle('analytics:getDashboard', async () => {
    ...
    try {
      ...
      const result = await catalystService.runWithContext(
        ...
        {
          operation: 'analytics:getDashboard',
          source: 'ipc_handler'
        }
      );
   ...
   */
  ipcMain.handle('analytics:getProgressChart', async (event, params) => {
    logger.info('Getting progress chart', {
    ...
    try {
      ...
      const result = await catalystService.runWithContext(
        ...
        {
          operation: 'analytics:getProgressChart',
          timeRange: params.timeRange,
          source: 'ipc_handler'
        }
      );
      ...
      logger.error('Failed to get progress chart', error as Error, params);
      throw error;
    }
  });
   ...
   */
  ipcMain.handle('analytics:getInsights', async (event, params) => {
    ...
    try {
      ...
      const result = await catalystService.runWithContext(
        ...
        {
          operation: 'analytics:getInsights',
          type: params.type,
          source: 'ipc_handler'
        }
      );
      ...
      logger.error('Failed to get learning insights', error as Error, params);
      throw error;
    }
  });
   ...
   */
  ipcMain.handle('analytics:getPerformance', async (event, params) => {
    ...
    try {
      ...
      const result = await catalystService.runWithContext(
        ...
        {
          operation: 'analytics:getPerformance',
          timeRange: params.timeRange,
          source: 'ipc_handler'
        }
      );
      ...
      logger.error('Failed to get performance metrics', error as Error, params);
      throw error;
    }
  });
