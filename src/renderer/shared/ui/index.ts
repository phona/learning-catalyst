 ...
 * 📚️ Usage:
 * ```typescript
 * import { Button, Input, ErrorBoundary } from '@/renderer/shared/ui';
 * ```
 */
 ...
 *
 * Full-screen loading with state-based messaging.
 *
 * @example
 * ```tsx
 * <LoadingScreen
...
// Page primitives (layout scaffolding)
export { PageScaffold, Section, Toolbar, EmptyState } from './PagePrimitives';

// Syntax highlighting wrapper
export { SyntaxHighlighterWrapper } from './SyntaxHighlighterWrapper';
