...
vi.mock('@/renderer/features/chat/ui/ToolFallback', () => ({
...
vi.mock('@/renderer/pages/chat/ChatPage', () => ({
  ChatPage: () => <div data-testid="chat-interface">Chat Page</div>,
  default: () => <div data-testid="chat-interface">Chat Page</div>,
}));
