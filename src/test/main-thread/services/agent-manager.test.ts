...
import { AgentManagerMain } from '../../../electron/main/services/agents/agent-manager';
import { ToolExecutorService } from '../../../electron/main/services/tool-executor';
...
jest.mock('../../../src/modules/concept-parsing/langchain-adapter', () => ({
  LangChainProviderAdapter: mockLangChainAdapter
}));

// Mock the ConceptProcessingPipeline
jest.mock('../../../src/modules/concept-parsing/pipeline', () => ({
