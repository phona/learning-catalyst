...
import { CatalystServiceMain } from '../../../electron/main/services/catalyst/catalyst-service';
...
describe('CatalystServiceMain', () => {
  ...
  describe('Error Handling', () => {
    it('should handle initialization errors gracefully', async () => {
      ...
      const originalCreateDatabase = require('../../../src/modules/database').createDatabase;
      require('../../../src/modules/database').createDatabase = async () => {
      ...
      require('../../../src/modules/database').createDatabase = originalCreateDatabase;
    });
