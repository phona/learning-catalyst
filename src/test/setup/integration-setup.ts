...
export async function setupIPCIntegrationTest() {
  ...
  (mockRendererProcess as any).disconnect = vi.fn();
...
export async function setupIntegrationTest() {
  ...
  const { mockCatalystService, mockDomainAgent, mockElectronIPC, mockAgentRegistry } = await import(
    '../utils/mocks/mock-services'
  );
