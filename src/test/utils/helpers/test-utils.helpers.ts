// @ts-nocheck
// Helper utilities for React Testing Library tests.
// This file contains only non-React helpers so it doesn't trigger
// react-refresh/only-export-components. React providers live in test-utils.tsx.
...
import { AllTheProviders, type AllTheProvidersProps } from './test-utils';
...
// Custom render function that includes providers (no JSX in this file)
...
// Re-export everything from React Testing Library to keep existing helpers working
