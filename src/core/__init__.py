...
from src.data.models.extended_models import KnowledgeMap, UserProgress, Context, ChallengeResult, ProgressReport, TrendData, AnalyticsExport, CompetencyProfile, Recommendations
