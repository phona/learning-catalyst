"""
Enhanced Database manager implementation with SQLite
"""
import json
import sqlite3
...
class EnhancedDatabaseManager:
    ...
    def insert_token_usage(self, model_name: str, provider: str, input_tokens: int,
                          output_tokens: int, user_id: str, context: str, cost: float = 0.0):
    ...
    def save_concept_relationship(self, source_concept_id: str, target_concept_id: str,
    ...
    def update_learning_session(self, session_id: str, concepts_covered: List[str],
                              challenges_completed: int, average_score: float):
    ...
    # QA History Methods
    def save_qa_record(self, user_id: str, concept_id: str, challenge_type: str,
                      challenge_text: str, user_answer: str, ai_evaluation: str,
                      score: float):
