...
## Purpose
Define the required message-persistence behavior for workflow nodes that use `interrupt()` so conversation history remains complete and correct after refresh/reload.
## Requirements
