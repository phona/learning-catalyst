...
## Purpose
Defines requirements for the AI provider abstraction layer that enables multiple AI service providers (OpenAI, ChatGLM, DeepSeek, SiliconFlow, local models) to be used interchangeably through a common interface.
