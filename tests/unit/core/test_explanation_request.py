...
class TestExplanationRequest:
    ...
    async def test_explanation_generation(self, model_service: MagicMock, knowledge_navigator: MagicMock):
        ...
        explanation = await catalyst_agent.generate_explanation(concept, {"learning_level": "intermediate"})
    ...
    async def test_explanation_format_consistency(self, model_service: MagicMock):
        ...
        model_service.send_message.return_value = type(
            ...
            (),
            {
                "content": "In Python, a dictionary is a collection of key-value pairs. "
        ...
        concept = Concept(
            ...
            content="Python dictionaries are collections of key-value pairs.",
            prerequisites=[],
            difficulty_level=1,
        )
    ...
    async def test_non_existent_concept_handling(self, model_service: MagicMock, knowledge_navigator: MagicMock):
        ...
        response = await catalyst_agent.generate_explanation(
            Concept(
